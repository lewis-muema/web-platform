<template lang="html">
  <div class="admin_invite_outer">
    <invite-component v-if="getState === 1" />
    <link-component v-if="getState === 2" />
    <many-component v-if="getState === 3" />
    <end-component v-if="getState === 4" />
    <link-show-component v-if="getState === 5" />
  </div>
</template>
