            ...
            <div class="section--filter-wrap">
                <div class="section--filter-input-wrap">
                    ...
                    <el-select class="section--filter-input"  v-model="filterData.department" placeholder="All Departments">
                        <el-option v-for="dept in fetchedDepartmentsData" :key="dept.department_name" :label="dept.department_name" :value="dept.department_id">
                        </el-option>
                    </el-select>
            ...
            filterUserTableData() {
                ...
                if(user_id !== '' && department !== ''){
                    ...
                    this.filteredUserData = this.filteredUserData.filter(function (user) {
                        return user.department_admin.toLowerCase() ==  user_id.toLowerCase()  && user.department_id == department;
                    });
                    ...
                    this.filteredUserData = this.filteredUserData.filter( user => user.department_admin.toLowerCase() ==  user_id.toLowerCase());
                    this.filterState = true;
