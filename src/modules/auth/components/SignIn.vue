    ...
    <div id="log_in" class="log-item">
        ...
        <div class="sign-inner">
            ...
            <div v-on:keyup.enter="sign_in">
                ...
                <div class="sign-holder dimen">
                    <input class="input-control sign-form" type="text" name="email" v-model="email"
                           placeholder="Email or Phone Number" autocomplete="on">
                </div>

                <div class="sign-holder dimen">
                    <input class="input-control sign-form" type="password" name="password" v-model="password"
                           placeholder="Password">
                </div>

                <div class="sign-holder">
                    <input class="button-primary sign-btn-color" type="submit" name="login_text" v-model="login_text"
                           v-on:click="sign_in">
                </div>
                ...
                <div class="sign-holder sign-sign-up sign-smaller">
                    ...
                    <router-link class="sign-holder__link" to="/auth/sign_up">Sign Up</router-link>
                </div>
            </div>
        </div>
    </div>
