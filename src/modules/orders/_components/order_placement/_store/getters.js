...
const get_active_vendor_name = state => state.active_vendor_name;
const get_active_order_option = state => state.active_order_option;

export default {
  get_waypoints,get_price_request_object,get_active_package_class,get_max_way_points,get_order_locations,get_active_vendor_name,get_active_order_option
};
