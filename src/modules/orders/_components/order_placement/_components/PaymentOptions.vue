            ...
            <div class="">
              ...
              >
                <div
                  ...
                  :key="index"
                >
                  <label class="delivery_label"> {{ $t('general.drop_off_instructions_at_name') }} </label>
                  <div
                    v-if="data.notes !== ''"
                    class="order_summary-wrapper__vendor instructions-notes"
                  >
              ...
              <div class="count_down_section">
                <p class="timeout_text">
                  {{ $t('general.order_will_be_placed_in') }}
                  <a class="timeout_count">{{ $t('general.time_seconds') }}</a>
                </p>
              </div>
        ...
        (response) => {
          ...
          if (response.status === 200) {
            ...
            this.doNotification(
              ...
              this.$t('general.mpesa-request_failed',{userPhone: userPhone, referenceNumber: referenceNumber}) + this.pending_amount,
