    ...
    <div class="">
        ...
        <div class="home-view-actions--note" v-if="get_active_order_option == 'payment'">
            ...
            <div class="home-view-notes-wrapper">
                ...
                <div class="home-view-notes-wrapper--item home-view-notes-wrapper--item__row" v-if="hide_payment">
        ...
        <div class="home-view-actions--note" v-if="get_active_order_option == 'note'">
            ...
            <div class="">
                <textarea name="name" rows="5" class="textarea-control" v-model="order_notes"
                          placeholder="Additional delivery instructions"></textarea>
            </div>
            <div class="">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            payment_display(){
                this.order_amount = this.order_cost;
                this.user_balance = this.getRunningBalance;
                let amount_to_pay = this.order_amount + this.user_balance;
                    if(this.user_balance > 0){
                        this.balance_quote = "You Owe";
                    }
