    ...
    <div class="">
        ...
        <div class="home-view-actions--note" v-if="get_active_order_option === 'payment'">
            ...
            <div class="home-view-notes-wrapper">
                <div class="home-view-notes-wrapper--item home-view-notes-wrapper--item__row" v-show="show_payment">
			...
			if (typeof this.active_vendor_price_data !== 'undefined') {
				if ('cost' in this.active_vendor_price_data) {
					if (
						...
						cost =
							this.active_vendor_price_data.cost - this.active_vendor_price_data.discountAmount;
						return cost;
					}
					cost =
						this.active_vendor_price_data.return_cost -
