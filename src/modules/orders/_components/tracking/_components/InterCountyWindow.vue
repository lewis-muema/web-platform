                        ...
                        <li
                         ...
                         :class="orderTimelineClass(vendor_timeline)">
                          <div :class="orderTimelineText(vendor_timeline)">
                            ...
                            <p class="eta_data" v-if="vendor_timeline.timestamp !== '' ">
          ...
          <div v-if="!truckMoreInfo && tracking_data !== undefined">
            <div v-if="!loading" class="infobar--outer">
              <div class="infobar--content infobar--content-padded">
                <div class="inter-county-infobar--photo infobar--content infobar--item infobar--item-bordered">
                  <img class="inter-county-img" src="https://images.sendyit.com/web_platform/vendor_type/side/v2/26.svg" />
                </div>
      ...
      <div>
        <transition name="fade" mode="out-in">
          <div class="">
            ...
            <el-dialog :visible.sync="showPaymentTab" class="cancelOptions">
              ...
              <div class="cancelOptions--content-wrap payments-wrap">
                ...
                <div class="cancelOptions--content-message">
                  ...
                  <span class="payments-headline">Kes 540</span>
                </div>
                <div
                  class="cancelOptions--content-message"
                >
                  <div class="">
                    <div
                    ...
                    <div v-if="payment_check === 'payment'" class="show-options">
...
export default {
  ...
  computed: {
    ...
    checkOrderMessage(){
      let resp = '' ;
      if (this.tracking_data !== undefined) {
        let data = this.tracking_data.order_timeline ;
        if (data.length > 0) {
  ...
  methods: {
    ...
    initiatePayment(){
      if (this.paymentOption === '') {
        ...
        if (Number(this.paymentOption) === 1) {
    ...
    requestMpesaPayment() {
      ...
      const mpesaPayload = {
        amount: this.tracking_data.amount,
        ...
        this.tracking_data.price_tier.currency : this.tracking_data.currency,
