...
const translations = {
  ...
  track: 'Track',
  dispute_extra_charges: 'Dispute Extra Charges',
  ...
  doc_resubmitted: 'Delivery docs resubmitted',
  doc_resolved: 'Delivery docs resolved',
  accept_driver_documents: 'Accept Driver Documents',
  reject_driver_documents: 'Reject Driver Documents',
  ...
  a_delivery_document_is_missing: 'A delivery document is missing',
  the_delivery_document_is_not_clear: 'The delivery document is not clear',
  the_delivery_document_is_not_valid: 'The delivery document is not valid',
  ...
  twentyfoot_flat_bed_trucks: 'Flatbed trucks',
  drop_off: 'Drop Off',
  fourtyfoot_flat_bed_trucks: 'Flatbed trucks',
  ...
  we_are_sorry_the_order_is_not_ready: 'We are sorry that your order is not ready. You can reschedule the pick up time of your order to another time.',
  we_are_sorry_you_entered_the_wrong_locations: 'We are sorry you entered the wrong locations. You can update the locations below. You may incur cost on updating your destinations',
  doing_our_best_to_match_your_order: 'We are doing our best to match your order with a suitable driver. please be patient',
  ...
  add_change_destination: 'Add or change destination',
  // infoComponent
  wrong_delivery_locations: 'Wrong delivery locations?',
  entered_wrong_locations: 'Entered wrong delivery locations?',
  not_available: 'Not available at the moment?',
  edit_locations: 'Edit locations',
  before_you_cancel: 'Before you cancel your order, may be we can help.',
  schedule_for_later: 'Schedule order for later?',
  isssue_with_order: 'Issue with your order?',
