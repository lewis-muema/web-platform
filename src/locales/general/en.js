...
const translations = {
  ...
  social_commerce_business: 'Social commerce business',
  social_commerce_business_definition: 'Your business mainly trades through facebook and instagram e.g. An online shoe store',
  Office: 'Office',
  Office_definition: 'You will use Sendy to send documents, packages from the office',
  Corporate: 'Corporate',
