const fr = {
  ...
  country: 'Pays',
  shipper_terms: 'En continuant, vous acceptez les conditions d’expédition de Sendy Fret.',
  ...
  no: 'Non',
  name: 'Nom',
  director_name_placeholder: 'Saisissez le nom du directeur(rice)',
  ...
  provide_all_director_details: 'Veuillez fournir tous les détails valides concernant le directeur',
  director_success_update: 'Succès de la configuration du directeur',
  director_success_update_msg: 'Les détails du directeur ont été mis à jour avec succès',
  invoice_no_failure: 'Échec de la configuration du numéro de facture',
  valid_phone_number: 'Veuillez fournir un numéro de téléphone valide',
  phone_verification: 'Vérification du téléphone',

  // Business Final SetUp
  all_done: 'Tout est terminé.',
  getting_ready: 'Maintenant, préparez-vous à déplacer la cargaison...',
  setting_your_business: 'Configurer votre compte de commerce',
  verify_details: 'Envoi de vos coordonnées pour vérification',
  customization: 'Personnalisation de votre expérience avec Sendy Fret.',
  almost_there: 'On y est presque...',
