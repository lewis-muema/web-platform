const translations = {
  ...
  wrong_delivery_location: 'Wrong delivery locations?',
  edit_locations: 'Edit locations',
  shedule_order_for_later: 'Schedule order for later?',
  schedule_order: 'Schedule order',
  still_want_cancel_order: 'Do you still want to cancel the order?',
  continue_to_cancel: 'CONTINUE TO CANCEL',
  add_or_change_locations:'Add or change locations',
  incur_cost_on_updating: 'You may incur cost on updating locations',
  price_updata: "Price update",
  total_cost_order: 'Total order cost',
  ...
  schedule_pickup_time_of_order: "Schedule pick up time of the order",
  sorry_we_could_not_update: "Sorry, we could not update the order because the location entered cannot be serviced by a {vendor_name} . Please try again with other locations",
  edit_location_failure: "Edit location failure",
  location_updated_successfully:'Locations updated successfully',
  location_update_failed:'Locations update failed',
  location_update_failed_text:'Locations update failed. Please check your internet connection and try again.',
  edit_instruction_error: 'Edit instructions error',
  valid_phone_recipient_notified: 'Kindly provide a valid phone number for the recipient to be notified',
  kindly_provide_valid_phone_number:'Kindly provide a valid phone number',
  additional_instructions_updated:'Additional instructions updated successfully',
  additional_instructions_failed:'Additional instructions update failed',
  additional_instructions_failed_text: 'Additional instructions update failed. Please check your internet connection and try again.',
  pickup_time_updated:'Pick up time updated successfully',
  pickup_time_update_failed: 'Pick up time update failed',
  pickup_time_update_failed_text:'Pick up time update failed. Please check your internet connection and try again.',

  edit_pickup_time_error:'Edit pick up time error',
  kinldy_provide_pickup_time: 'Kindly provide order pick up time',
  // intercountyWIndow
  status: 'Status',
